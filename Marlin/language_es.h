...
#define MSG_BED_HOMING_WAIT                 _UxGT("por favor espere...")
#define MSG_ADHESION                         _UxGT("Aplicar laca")
#define MSG_ADHESIVE_1                      _UxGT("Aplicar laca y click")
#define MSG_ADHESIVE_2                      _UxGT("para continuar...")
...
#define MSG_PREHEAT_NOZZLE                  _UxGT("Boquilla")
#define MSG_PREHEAT_HEATBED                  _UxGT("Cama")
#define MSG_PREHEAT_CUSTOM                   _UxGT("Precal. Manual")
#define MSG_LAYER                            _UxGT("Capas:") 

#define MSG_PREHEAT_1_N                     MSG_PREHEAT_1 _UxGT(" ")
#define MSG_PREHEAT_1_ALL                   MSG_PREHEAT_1 _UxGT("Todo")
#define MSG_HEAT_NOZZLE                      _UxGT("Boquilla")
...
#define MSG_BED_LEVELING                    _UxGT("Nivelando ")
...
#define MSG_CALIBRATIONS                     _UxGT("Calibraciones")
#define MSG_CONTROL                         _UxGT("Control")
#define MSG_PROBE_WIZARD                    _UxGT("Asistente sonda Z")
#define MSG_AUTO_Z_ALIGN                    _UxGT("Auto alineado Z")
#define WARNING_COLISION_1                  _UxGT("Advertencia: el eje Z")
#define WARNING_COLISION_2                  _UxGT("Chocará con la parte")
#define WARNING_COLISION_3                  _UxGT("superior de la maquina")
#define MSG_ZOFFSET_CALIBRATION_WIZ_6       _UxGT("Click para continuar")
#define MSG_QUESTIONSAVE                    _UxGT("¿Guardar?")
#define MSG_SAVE                            _UxGT("Guardar")
#define MSG_EXIT                            _UxGT("Salir")
...
#define MSG_FILAMENT_UNLOADING              _UxGT("Quitando filamento")
#define MSG_FILAMENT_LOADING                _UxGT("Cargando filamento")
#define MSG_MENSAJE_1                       _UxGT("Seleccione")
#define MSG_MENSAJE_2                       _UxGT("la temperatura")
#define MSG_MENSAJE_3                       _UxGT("Extrusor:")
#define MSG_PREDET                          _UxGT("Predeterminado")
#define MSG_PREHEAT_PLA                     _UxGT("Precalentar PLA")
#define MSG_PREHEAT_ABS                     _UxGT("Precalentar ABS")
#define MSG_PREHEAT_FLEX                    _UxGT("Precalentar FLEX")
#define MSG_PREHEAT_NLN                     _UxGT("Precalentar NLN")
...
#define MSG_FILAMENTCHANGE_NOW              _UxGT("Ahora")
#define MSG_FILAMENTCHANGE_LAYER            _UxGT("En capa")
...
#define MSG_LED_OFF                         _UxGT("Prender LED")
#define MSG_LED_ON                          _UxGT("Apagar LED")
#if LCD_WIDTH > 19
